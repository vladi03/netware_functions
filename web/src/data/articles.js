import torahMosaicReport from './articles/torah-mosaic-report.txt?raw';

export const articles = [
  {
    slug: 'torah-mosaic-report',
    ...
    readingMinutes: '12 min read',
    audioSrc: '/audio/torah-mosaic-report.mp3',
    body: torahMosaicReport,
  },
];
